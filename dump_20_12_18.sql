...
CREATE FUNCTION public.create_user(_name character varying, _surname character varying, _username character varying, _password character varying, _email character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
BEGIN
...
5	Савелий	Вепрев	nakazan	123	nakazan@gmail.com
\.
